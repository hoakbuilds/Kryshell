...
void printhelp(){
	...
	printf("----> soread [BYTES] [FDIN] [FDOUT]	Reads the first N specified BYTES from an opened file with file descriptor FDIN and writes them to the file descriptor FDOUT\nExample:\nsoread 18 2 1\nwill you pri\n\n");
